...
writeFileSync(join(root,'CONTENT-MANIFEST.json'),JSON.stringify({schemaVersion:2,scope:'RUNTIME_ARTIFACTS',skillName:release.skillName,version:release.version,files},null,2)+'\n');
